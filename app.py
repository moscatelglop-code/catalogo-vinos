...
Limpieza de caracteres: FPDF suele dar error Latin-1 codec can't encode character... con símbolos como el euro (€) o comillas especiales. La función clean_txt previene que la app se caiga al generar el PDF.
